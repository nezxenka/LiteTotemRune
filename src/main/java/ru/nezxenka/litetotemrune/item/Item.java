...
public class Item {
    ...
    public ItemStack giveItem(Player var1) {
        ...
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(LiteTotemRune.getInstance(), "bessmertie"), PersistentDataType.INTEGER, 1);
